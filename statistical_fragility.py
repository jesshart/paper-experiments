    ...
    mo.vstack(
        [
            ...
            mo.md(
                ...
                *An exploratory notebook by [Jesse Hartman](https://www.linkedin.com/in/jesse-ryan-hartman/).
...
def _(causal_bonf, causal_hunter, causal_result, mo, np):
    ...
    _show_stink = _n_passing > 0 and _threshold > causal_bonf + 1e-10
...
def _(anywidget, traitlets):
    ...
    return (SparseFeatureGallery,)


@app.cell(hide_code=True)
def _(SparseFeatureGallery, mo, sae_result):
...
def _(mo):
    ...
    n_concepts_slider
    return (n_concepts_slider,)


@app.cell(hide_code=True)
def _(attr_W, n_concepts_slider, normal_cdf, np):
    ...
    return concept_alpha, concept_bonf, concept_result


@app.cell(hide_code=True)
def _(FalsePositiveHunter, concept_alpha, concept_bonf, concept_result, mo):
    ...
    concept_hunter
    return (concept_hunter,)


@app.cell(hide_code=True)
def _(concept_bonf, concept_hunter, concept_result, mo, np):
...
def _(mo):
    ...
    n_circuits_slider
    return (n_circuits_slider,)


@app.cell(hide_code=True)
def _(n_circuits_slider, normal_cdf, np):
    ...
    return circuit_alpha, circuit_bonf, circuit_result


@app.cell(hide_code=True)
def _(FalsePositiveHunter, circuit_alpha, circuit_bonf, circuit_result, mo):
    ...
    circuit_hunter
    return (circuit_hunter,)


@app.cell(hide_code=True)
def _(circuit_bonf, circuit_hunter, circuit_result, mo, np):
